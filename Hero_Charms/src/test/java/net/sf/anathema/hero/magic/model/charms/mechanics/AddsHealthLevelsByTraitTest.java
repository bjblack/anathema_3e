...
public class AddsHealthLevelsByTraitTest
{
	...
	private void createMechanics (String charmName, int numberOfMechanics, DummyCharmProviderForMechanics provider)
	{
		...
		healthLevels.put (1, new HealthLevelType[]
		{
			HealthLevelType.ONE
		}
		);
		healthLevels.put (2, new HealthLevelType[]
		{
			HealthLevelType.ONE, HealthLevelType.TWO
		}
		);
		healthLevels.put (3, new HealthLevelType[]
		{
			HealthLevelType.ONE, HealthLevelType.TWO, HealthLevelType.TWO
		}
		);
		healthLevels.put (4, new HealthLevelType[]
		{
			HealthLevelType.ONE, HealthLevelType.ONE, HealthLevelType.TWO
		}
		);
		healthLevels.put (5, new HealthLevelType[]
		{
			HealthLevelType.ZERO, HealthLevelType.ONE, HealthLevelType.ONE
		}
		);
