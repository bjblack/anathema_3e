...
public class StringUtilitiesTest
{
	...
	public void testFindLineBreaks () throws Exception
	{
		...
		, StringUtilities.findBreakPoints ("Hallo Du!", 2)));
		Assert.assertTrue (Arrays.equals (new int[]
		{
			6, 9
		}
		, StringUtilities.findBreakPoints ("Hallo Du da!", 3)));
		Assert.assertTrue (Arrays.equals (new int[]
		{
			6
		}
		...
		, StringUtilities.findBreakPoints ("Oh Du Lebest draussen!", 3)));
		...
		, StringUtilities.findBreakPoints ("Zu kurz.", 3)));
	}
