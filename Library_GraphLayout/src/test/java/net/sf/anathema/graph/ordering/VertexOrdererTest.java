...
public class VertexOrdererTest
{
	...
	public void testSugiyamaFourLayerExample () throws Exception
	{
		...
		ISimpleNode h = NodeFactory.createMultiChildNode (3, new ISimpleNode[]
		{
			j, k
		}
		, "h");
		...
		ISimpleNode e = NodeFactory.createMultiChildNode (2, new ISimpleNode[]
		{
			g, h, i
		}
		, "e");
		...
		, graph.getNodesByLayer (3)));
		assertTrue (Arrays.equals (new ISimpleNode[]
		{
			l, k, j
		}
		, graph.getNodesByLayer (4)));
	}
	...
	public void testSolarRide () throws Exception
	{
		...
		new ISimpleNode[]
		{
			partnership, feathery, sustaining
		}
		,
		"Sustaining Method");
		ISimpleNode whistle = NodeFactory.createMultiChildNode (2, new ISimpleNode[]
		{
			spirit, phantom
		}
		, "Horse Whistle");
	...
	public void testPartialCraft () throws Exception
	{
		...
		ISimpleNode B = NodeFactory.createMultiChildNode (1, new ISimpleNode[]
		{
			D, E, F
		}
		, "B");
		ISimpleNode A = NodeFactory.createMultiChildNode (1, new ISimpleNode[]
		{
			E
		}
		, "A");
